...
namespace DAL
{
    public class ExcelExport
    {
        ...
        public const string T_DanhMucKhoa = "Report";
        #endregion
        ...
        public bool ExportKhoa(List<tbl_order> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
        ...
        //    replacer.Add(V_TONGSO, "100");
            ...
            return OutSimpleReport(dataSource, replacer, "Report", isPrintPreview, ref fileName);
        }
        public bool ExportReport(List<tbl_order> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            string tongSo = dataSource.Sum(t => int.Parse( t.price)).ToString();
            // Create replacer
            Dictionary<string, string> replacer = new Dictionary<string, string>();
